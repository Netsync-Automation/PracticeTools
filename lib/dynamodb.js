...
export class DynamoDBService {
  ...
  // Assignment methods
  async addAssignment(practice, status, projectNumber, requestDate, eta, customerName, projectDescription, region, am, pm, resourceAssigned, dateAssigned, notes, documentationLink = '', pmEmail = '', attachments = []) {
    const id = uuidv4();
