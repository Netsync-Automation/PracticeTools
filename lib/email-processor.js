...
${email.body}`;
  ...
  async resolveUserFromName(name, allUsers = null) {
    ...
    // Fallback to email inference with assumed flag
    ...
    return { name: name, email: inferredEmail, isAssumed: true };
  }
